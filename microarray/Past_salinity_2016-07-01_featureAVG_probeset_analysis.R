...
# look at MA plot with controls first
...
head(salinity.data.filtered.flags)
plotMD(tmp_data)
# this shows a relationship between M and A
# as a result, according to limma manual
# background correction needs to be done
...
# Look at control probe intensities, how?
...
normDat_between<-normalizeBetweenArrays(salinity.data.matrix,method="quantile")
...
fac= factor(c("sal25ppt","sal30ppt","sal35ppt"))
...
colnames(norm.data.reps)<-c("c253295110048_ar2_jun1912_A_SL","c253295110048_ar1_jun1912_B_SL","c253295110048_ar4_jun1912_C_SL",
                            "c253295110048_ar3_jun1912_A_L","c253295110048_ar6_jun1912_B_L","c253295110048_ar5_jun1912_C_L",
                            "c253295110048_ar8_jun1912_A_C","c253295110048_ar7_jun1912_B_C","c253295110054_ar2_jul1112_C_C","Name")
